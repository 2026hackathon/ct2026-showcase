...
- 🎨 [设计系统 skill](https://github.com/unirain/menupilot-design-skill) — 提取为可复用 Claude Code skill（视觉 token + 组件模式 + 幻灯片全链路）
- 📊 [演讲 PPT]([https://github.com/2026hackathon/menupilot/blob/master/ppt/menupilot-deck.html](https://github.com/2026hackathon/menupilot/blob/main/ppt/menupilot-deck.pptx)) — 日光精密仪器语法, 11 页 + 算法附录
